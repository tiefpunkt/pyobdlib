...
SENSORS = [
	...
	Sensor("0122",	"Fuel_Rail_Pressure_(rel",	"FFuel Rail Pressure (relative to manifold vacuum)"),
	Sensor("0123",	"Fuel_Rail_Pressure_(die",	"Fuel Rail Pressure (diesel, or gasoline direct inject)"),
	...
	Sensor("0133",	"Barometric_pressure",		"Barometric_pressure", 	  to_int,				 "kPa"),
	...
	Sensor("0147",	"throttle_pos_B",			"Absolute throttle position", to_percent_scale,	 "%"),
	Sensor("0148",	"throttle_pos_C",			"Absolute throttle positi", to_percent_scale,	 "%"),
	Sensor("0149",	"accelerator_pos_D",		"Accelerator_pedal_positi", to_percent_scale,	 "%"),
	Sensor("014A",	"accelerator_pos_E",		"Accelerator_pedal_positi", to_percent_scale,	 "%"),
	Sensor("014B",	"accelerator_pos_F",		"Accelerator_pedal_positi", to_percent_scale,	 "%"),
