...
SENSORS = [
    ...
    Sensor("0121", "Distance_traveled_with_mil_on", "Distance traveled with malfunction indicator lamp (MIL) on", to_int, "km"),
    ...
    Sensor("0147", "Absolute_throttle_position_B", "Absolute_throttle_positi", to_percent_scale,     "%"),
    Sensor("0148", "Absolute_throttle_position_C", "Absolute_throttle_positi", to_percent_scale,     "%"),
