...
SENSORS = [
	...
	Sensor("011C",	"obd_standard",				"OBD Designation", to_ODB_standard),
	...
	Sensor("0121",	"distance_with_mil",		"Distance traveled with malfunction indicator lamp (MIL) on", to_int, "km"),
	Sensor("0122",	"fuel_rail_pressure_rel",	"Fuel Rail Pressure (relative to manifold vacuum)"),
	Sensor("0123",	"fuel_rail_pressure",		"Fuel Rail Pressure (diesel, or gasoline direct inject)"),
	...
	Sensor("012C",	"Commanded_EGR",			"Commanded EGR", 							to_percent_scale,	"%"),
	...
	Sensor("0130",	"of_warm-ups_since_cod",	"Number of warm-ups since codes cleared",	to_int),
	Sensor("0131",	"Distance_traveled_since",	"Distance traveled since codes cleared",	to_int,				"km"),
	Sensor("0132",	"Evap._System_Vapor_Pres",	"Evap._System_Vapor_Press"),
	Sensor("0133",	"bar_pressure",				"Barometric pressure", 	  					to_int,				"kPa"),
	...
	Sensor("013C",	"Catalyst_Temperature",		"Catalyst Temperature Bank 1, Sensor 1",	to_temp_c,			"C"),
	Sensor("013D",	"Catalyst_Temperature",		"Catalyst Temperature Bank 2, Sensor 1",	to_temp_c,			"C"),
	Sensor("013E",	"Catalyst_Temperature",		"Catalyst Temperature Bank 1, Sensor 2",	to_temp_c,			"C"),
	Sensor("013F",	"Catalyst_Temperature",		"Catalyst Temperature Bank 2, Sensor 2",	to_temp_c,			"C"),
	Sensor("0140",	"pids3",					"PIDs_supported_[41_-_60]", 				to_bitstring),
	Sensor("0141",	"Monitor_status_this_dri",	"Monitor_status_this_driv"),
	Sensor("0142",	"control_module_voltage",	"Control module voltage", 					to_int,				"mV"),
	...
	Sensor("0147",	"throttle_pos_B",			"Absolute throttle position B",				to_percent_scale,	"%"),
	Sensor("0148",	"throttle_pos_C",			"Absolute throttle position C",				to_percent_scale,	"%"),
	Sensor("0149",	"accelerator_pos_D",		"Accelerator_pedal_position D",				to_percent_scale,	"%"),
	Sensor("014A",	"accelerator_pos_E",		"Accelerator_pedal_position E",				to_percent_scale,	"%"),
	Sensor("014B",	"accelerator_pos_F",		"Accelerator_pedal_position F",				to_percent_scale,	"%"),
